...
def items_can_produce_result(items: Sequence[ItemType]) -> bool:
    ...
    This checks item configuration before view construction; :func:`view_can_produce_result` in the view module
    checks the resulting discord.py view. Both distinguish interactive screens from terminal static layouts.
    """
